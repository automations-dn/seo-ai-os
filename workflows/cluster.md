...
1. **DuckDuckGo AI Keyword Ideas**
   ```bash
   # Use get_free_ai_answer tool with specific topic queries
   "Identify top 30 high-volume keywords and questions for [topic]"
   ```
...
1. **Get SERP Data**
   ```bash
   # Use WebSearch or playwriter MCP to analyze the live SERP for [topic]
   ```
